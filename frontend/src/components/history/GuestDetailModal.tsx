...
import { X, Phone, Mail, GraduationCap, QrCode, UtensilsCrossed, CheckCircle, Calendar } from 'lucide-react'
import type { GuestDetail } from '@/lib/mockData'
        ...
        <div className="overflow-y-auto flex-1 no-scrollbar">
          ...
          <div className="px-6 pb-8">
            ...
            {[1, 2, 3].map(dayNum => {
              ...
              const receivedSlots = dayMeals.map(m => m.slotTitle)
